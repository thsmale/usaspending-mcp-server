...
response_schema = {
    'type': 'object',
    'required': ['count', 'limit', 'hasNext', 'page', 'hasPrevious', 'next', 'fy', 'results'],
    'properties': {
        ...
        'results': {
            ...
            'items': {
                'type': 'object',
                'required': ['account_name', 'account_number', 'account_id', 'managing_agency_acronym', 'agency_identifier', 'budgetary_resources', 'managing_agency'],
                'properties': {
                    'account_name': {
                        'type': ['string', 'null'],
