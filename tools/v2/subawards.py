...
tool_subawards = Tool(
    ...
    inputSchema={
        ...
        'properties': {
            ...
            'sort': { 'type': 'string', 'enum': ['subaward_number', 'id', 'description', 'action_date', 'amount', 'recipient_name']},
...
response_schema = {
    ...
    'properties': {
        'results': {
            ...
            'items': {
                'type': 'object',
                'required': ['id', 'subaward_number', 'description', 'action_date', 'amount', 'recipient_name'],
                'properties': {
                    'id': { 'type': 'number' },
