    ...
    inputSchema={
        ...
        'properties': {
            'sort': {
                ...
                'enum': ['agency_id', 'agency_name', 'active_fy', 'active_fq', 'outlay_amount', 'obligated_amount', 'budget_authority_amount', 'current_total_budget_authority_amount', 'percentage_of_total_budget_authority']
            },
            'order': {
                'type': 'string',
...
response_schema = {
    ...
    'properties': {
        'results': {
            ...
            'items': {
                'type': 'object',
                'required': ['abbreviation', 'active_fq', 'active_fy', 'agency_id', 'agency_name', 'budget_authority_amount', 'congressional_justification_url', 'current_total_budget_authority_amount', 'obligated_amount', 'outlay_amount', 'percentage_of_total_budget_authority', 'toptier_code', 'agency_slug'],
                'properties': {
